...
export class InMemoryDataService implements InMemoryDbService {
    createDb() {
        let smoothies = [
                { id: 1, name: 'Apfel',    image: 'foto',  bewertung: 4, groesse: 200, zutaten: Ingredients[('Apfel', 1, Unit.Stueck),('Orange', 2, Unit.Stueck),('Banane', 3, Unit.EL) ],     zubereitung: ' Waschen, schneiden' },
