System.register(["@angular/core", "./ingredients-mockdata"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, ingredients_mockdata_1, IngredientsService;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            ...
            exports_1("IngredientsService", IngredientsService);
        }
    };
});
