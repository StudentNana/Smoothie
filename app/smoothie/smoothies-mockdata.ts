...
export const SMOOTHIES: Smoothie[] = [
    { id: 1, name: 'Apfel',    image: 'foto',  bewertung: 4, groesse: 200, zutaten: '1 Banane, 200g Himbeeren ',     zubereitung: ' Waschen, schneidenDie Früchte in kleine Stücke <br> seiden. Diese kommen in den Mixer mit einem Teil der Milch. Dann gut mixen bis keine Stücke mehr vorhanden sind. Den Rest der Milch dazugeben und zuckern, wenn nötig. In Gläser abfüllen und genießen.  Schmeckt auch sehr gut mit Beeren!' },
